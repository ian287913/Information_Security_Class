...
string Decoder::DES(string _key, string _plaintext)
{
...
bitset<64> Decoder::Permutation(bitset<64> arr, int table[])
{
	bitset<64> arr_new;
...
bitset<32> Decoder::Permutation32(bitset<32> arr, int table[])
{
	bitset<32> arr_new;
...
bitset<56> Decoder::Permutation56(bitset<64> arr)
{
	bitset<56> arr_new;
...
bitset<48> Decoder::Permutation48(bitset<56> arr)
{
	bitset<48> arr_new;
...
bitset<48> Decoder::Expansion(bitset<32> arr, int table[])
{
	bitset<48> arr_new;
...
bitset<32> Decoder::FunctionF(bitset<32> R32, bitset<48> K48)
{
	bitset<32> result32;
...
bitset<32> Decoder::SBox(bitset<48> bs48)
{
	string result32 = "";
...
bitset<56> Decoder::KeyRound(bitset<56> bs, int round)
{
...
void Decoder::Bits64to32(bitset<64> bs64, bitset<32> &bsL, bitset<32> &bsR)
{
	//	注意: R在低位元、L在高位元
	for (int i = 0; i < 64; i++)
	{
...
void Decoder::Swap32(bitset<32>& bsL, bitset<32>& bsR)
{
...
//	(64 bits)
bitset<64> Decoder::String2Bits(string s)
{
	string sL = "";
...
string Decoder::Bits2String(bitset<64> bs)
{
	stringstream ss;
